                                ...
                                <div class="panel-body pa-0">
                                    <div class="sm-data-box">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <img src = "{{ asset('/public/img/new/services.png') }}"
                                                        class="img-responsive" alt="Service Image">
                                                </div>
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <span class=" uppercase-font block font-13">Services</span>
                                                    <span class="txt-dark1 block counter"><span
                                                            class="counter-anim" style="font-weight: bolder;">{{ $totalservices }}</span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <img src = "{{ asset('/public/img/new/countries.png') }}"
                                                        class="img-responsive" alt="Country Image">
                                                </div>
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    ...
                                                    <span class="txt-dark1 block counter"><span
                                                            class="counter-anim" style="font-weight: bolder;">{{ $totalcompanies }}</span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <img src = "{{ asset('/public/img/new/transections.png') }}"
                                                        class="img-responsive" alt="Transaction Image">
                                                </div>
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                                    <span
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                                    <img src = "{{ asset('/public/img/new/partners.png') }}"
                                                        class="img-responsive" alt="Partner Image">
                                                </div>
                                                <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
