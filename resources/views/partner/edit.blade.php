                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="passport_date_of_expiry" type="date" class="m-77 text-center form-control" placeholder="Passport Expiry Date" name="passport_date_of_expiry" value="{{ $partner->passport_date_of_expiry }}" required>
                               ...
                               <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="passport_date_of_issue" type="date" class="m-77 text-center form-control" placeholder="Passport Issue Date" name="passport_date_of_issue" value="{{ $partner->passport_date_of_issue }}" required>
