    ...
    <div class="wrapper  pa-0">
        <header class="sp-header">
            <div class="sp-logo-wrap pull-left">
                <a href="">
                    <img class="brand-img mr-10" width="79px" height="54px" src="{{ asset('/public/img/logo.png') }}"
                        alt="brand" />
                                ...
                                <div class="auth-form ml-auto mr-auto no-float">
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12">
                                            <div class="mb-30">
                                                <h1 class="text-start txt-dark mb-10 custom-font"
                                                    style="font-weight: bold;">Welcome!</h1>
                                                <h6 class="text-start nonecase-font txt-grey custom-font">Login To
                                                    Continue</h6>
                                            </div>
                                            @if (session('error'))
                                                ...
                                                <form id="loginForm" method="POST" action="{{ route('post_login') }}">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-6 text-right">
                                                            <a class="mt-5 capitalize-font txt-primary block font-15"
